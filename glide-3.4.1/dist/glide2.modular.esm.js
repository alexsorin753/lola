...
var defaults = {
  ...
  classes: {
    ...
    slider: 'glide2--slider',
    carousel: 'glide2--carousel',
    swipeable: 'glide2--swipeable',
    dragging: 'glide2--dragging',
    cloneSlide: 'glide2__slide--clone',
    activeNav: 'glide2__bullet--active',
    activeSlide: 'glide2__slide--active',
    disabledArrow: 'glide2__arrow--disabled'
  }
};
 ...
 * Each extension receives access to instance of glide2 and rest of components.
 *
 * @param {Object} glide2
 ...
 * @returns {Object}
 */
function mount(glide2, extensions, events) {
  var components = {};

  for (var name in extensions) {
    if (isFunction(extensions[name])) {
      components[name] = extensions[name](glide2, components, events);
    } else {
...
var glide2 = function () {
  ...
  createClass(glide2, [{
    ...
    /**
     * Updates glide2 with specified settings.
     *
     * @param {Object} settings
     * @return {glide2}
     */
    ...
    /**
     * Sets glide2 into a idle status.
     *
     * @return {glide2}
     */
    ...
    /**
     * Sets glide2 into a active status.
     *
     * @return {glide2}
     */
    ...
    /**
     * Checks if glide2 is a precised type.
     *
     * @param  {String} name
     * @return {Boolean}
     */
...
function Run (glide2, Components, Events) {
  var Run = {
    /**
     * Initializes autorunning of the glide2.
     *
     * @return {Void}
     */
    ...
    /**
     * Makes glide2s running based on the passed moving schema.
     *
     * @param {String} move
     */
...
var TRACK_SELECTOR = '[data-glide2-el="track"]';
...
function Html (glide2, Components) {
  ...
  define(Html, 'root', {
    /**
     * Gets node of the glide2 main element.
     *
     * @return {Object}
     */
    get: function get() {
    ...
    /**
     * Sets node of the glide2 main element.
     *
     * @return {Object}
     */
    set: function set(r) {
  ...
  define(Html, 'track', {
    /**
     * Gets node of the glide2 track with slides.
     *
     * @return {Object}
     */
    get: function get() {
    ...
    /**
     * Sets node of the glide2 track with slides.
     *
     * @return {Object}
     */
    set: function set(t) {
...
function Move (glide2, Components, Events) {
   ...
   * - before build, so glide2 will start at `startAt` index
...
function Sizes (glide2, Components, Events) {
  ...
  define(Sizes, 'width', {
    /**
     * Gets width value of the glide2.
     *
     * @return {Number}
     */
    get: function get() {
  ...
  define(Sizes, 'slideWidth', {
     ...
     */
    get: function get() {
      return Sizes.width / glide2.settings.perView - Components.Peek.reductor - Components.Gaps.reductor;
    }
  });

  /**
   * Apply calculated glide2's dimensions:
  ...
  /**
   * Remove calculated glide2's dimensions:
...
function Build (glide2, Components, Events) {
  var Build = {
    /**
     * Init glide2 building. Adds classes, sets
    ...
    /**
     * Adds `type` class to the glide2 element.
     *
     * @return {Void}
     */
...
function Clones (glide2, Components, Events) {
  var Clones = {
    ...
    collect: function collect() {
      ...
      var slides = Components.Html.slides;
      var _glide2$settings = glide2.settings,
          perView = _glide2$settings.perView,
          classes = _glide2$settings.classes;
   ...
   * - while glide2's type is `carousel`
   */
...
/**
 * Reflects value of glide2 movement.
 *
 * @param  {Object} glide2
...
function Rtl (glide2, Components) {
  return {
    /**
     * Negates the passed translate if glide2 is in RTL option.
     *
...
/**
 * Updates glide2 movement with a `gap` settings.
 *
 * @param  {Object} glide2
 * @param  {Object} Components
 * @return {Object}
...
/**
 * Updates glide2 movement with width of additional clones width.
 *
 * @param  {Object} glide2
 * @param  {Object} Components
 * @return {Object}
...
/**
 * Updates glide2 movement with a `peek` settings.
 *
 * @param  {Object} glide2
 * @param  {Object} Components
 * @return {Object}
...
/**
 * Updates glide2 movement with a `focusAt` settings.
 *
 * @param  {Object} glide2
 * @param  {Object} Components
 * @return {Object}
...
function swipe (glide2, Components, Events) {
  ...
  var Swipe = {
    ...
    move: function move(event) {
      if (!glide2.disabled) {
        var _glide2$settings = glide2.settings,
            touchAngle = _glide2$settings.touchAngle,
            touchRatio = _glide2$settings.touchRatio,
            classes = _glide2$settings.classes;
    ...
    /**
     * Handler for `swipeend` event. Finitializes user's tap and decides about glide2 move.
     *
     * @param {Object} event
     * @return {Void}
     */
...
function images (glide2, Components, Events) {
  ...
  var Images = {
    /**
     * Binds listener to glide2 wrapper.
     *
     * @return {Void}
     */
    mount: function mount() {
...
function anchors (glide2, Components, Events) {
  ...
  var Anchors = {
    ...
    /**
     * Handler for click event. Prevents clicks when glide2 is in `prevent` status.
     *
     * @param  {Object} event
     * @return {Void}
     */
    ...
    /**
     * Detaches anchors click event inside glide2.
     *
     * @return {self}
     */
    ...
    /**
     * Attaches anchors click events inside glide2.
     *
     * @return {self}
     */
...
var NAV_SELECTOR = '[data-glide2-el="controls[nav]"]';
var CONTROLS_SELECTOR = '[data-glide2-el^="controls"]';
...
function controls (glide2, Components, Events) {
  ...
  var Controls = {
    ...
    click: function click(event) {
      ...
      Components.Run.make(Components.Direction.resolve(event.currentTarget.getAttribute('data-glide2-dir')));
    }
  };
...
function keyboard (glide2, Components, Events) {
  ...
  var Keyboard = {
    ...
    /**
     * Handles keyboard's arrows press and moving glide2 foward and backward.
     *
     * @param  {Object} event
     * @return {Void}
     */
...
function autoplay (glide2, Components, Events) {
  ...
  var Autoplay = {
    ...
    /**
     * Stops autorunning of the glide2.
     *
     * @return {Void}
     */
    stop: function stop() {
    ...
    /**
     * Stops autoplaying while mouse is over glide2's area.
     *
     * @return {Void}
     */
    bind: function bind() {
  ...
  define(Autoplay, 'time', {
     ...
     * times in `data-glide2-autoplay` attrubutes over options.
     *
     * @return {Number}
     */
    get: function get() {
      var autoplay = Components.Html.slides[glide2.index].getAttribute('data-glide2-autoplay');
  ...
  /**
   * Destroy a binder:
   * - on destroying glide2 instance to clearup listeners
   */
  Events.on('destroy', function () {
    Binder.destroy();
  });
...
function breakpoints (glide2, Components, Events) {
  ...
  /**
   * Update glide2 with settings of matched brekpoint:
...
var glide2$1 = function (_Core) {
  inherits(glide2$$1, _Core);

  function glide2$$1() {
    classCallCheck(this, glide2$$1);
    return possibleConstructorReturn(this, (glide2$$1.__proto__ || Object.getPrototypeOf(glide2$$1)).apply(this, arguments));
  }

  createClass(glide2$$1, [{
    key: 'mount',
    value: function mount() {
      var extensions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

      return get(glide2$$1.prototype.__proto__ || Object.getPrototypeOf(glide2$$1.prototype), 'mount', this).call(this, _extends({}, COMPONENTS, extensions));
    }
  }]);
  return glide2$$1;
}(glide2);

export default glide2$1;
